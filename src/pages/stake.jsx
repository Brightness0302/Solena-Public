...
export default function Stake() {
  ...
  const durationRange = useMemo(
    () => (downMd ? mobileDurationRange : desktopDurationRange),
    [downMd]
  );
  const [stakingTokenAmount, setStakingTokenAmount] = useState(0.0);
  const [solAmount, setSolAmount] = useState(0.3);
  ...
  return (
    <div className="flex justify-center items-start px-5 py-1 md:p-0">
      <div className="z-10 flex flex-col justify-between items-center bg-[#1B1B36] border-0 sm:border-2 border-[#ECFDFF10] w-full sm:w-[620px] rounded-[34px] p-0 sm:px-12 sm:py-8 gap-5">
        ...
        <div className="flex flex-col w-full gap-2">
          ...
          <div className="relative flex flex-col mx-2">
            ...
            <span
              ...
              style={{
                width: `${(100 / (durationRange.length - 1)) * duration}%`,
              }}
            ></span>
            <input
              id="medium-range"
